    ...
    <ion-content class="ion-padding auth-page">
      <div class="auth-shell">
        <div class="auth-card">
          ...
          <p class="auth-copy">Sign up to keep your personal spending data separate.</p>

          <ion-item>
            <ion-icon :icon="personOutline" slot="start" aria-hidden="true" />
            <ion-input
              v-model="displayName"
              label="Full name"
          ...
          <ion-button expand="block" class="auth-button" @click="signup">
            <ion-icon :icon="personAddOutline" slot="start" aria-hidden="true" />
            Create account
          </ion-button>
        ...
        <aside class="auth-visual" aria-label="Monace Tracker overview">
          ...
          <div class="visual-content">
            ...
            <h2>Start your<br />better habits.</h2>
            <p>Keep your daily expenses organized, understand your habits, and make every peso count.</p>
...
import { lockClosedOutline, mailOutline, personAddOutline, personOutline, pricetagOutline, shieldCheckmarkOutline, trendingUpOutline } from 'ionicons/icons'
